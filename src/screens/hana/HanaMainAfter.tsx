...
export default function HanaMainAfter() {
  ...
  return (
    <Container>
      <Header>
        <RowImage> 
          <Image source={require("../../assets/header1.png") }style={{ width: 100, height: 25 }} />
          <Image source={require("../../assets/header2.png") }style={{ width: 150, height: 25 }} />
        </RowImage>
      </Header>
      <MainProduct>
        <FlatList
